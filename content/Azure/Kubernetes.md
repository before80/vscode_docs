...
## [Before you begin 开始之前]({{< ref "/Azure/Kubernetes#_before-you-begin" >}})
...
## [Install the Kubernetes extension 安装 Kubernetes 扩展]({{< ref "/Azure/Kubernetes#_install-the-kubernetes-extension" >}})
...
## [Containerize and publish the application 将应用程序容器化并发布]({{< ref "/Azure/Kubernetes#_containerize-and-publish-the-application" >}})

You can follow the [Working with Docker]({{< ref "/Azure/Docker" >}}) tutorial to build your project, generate a Docker image, and push it to a public or private container registry through the Microsoft [Docker Extension](https://marketplace.visualstudio.com/items?itemName=ms-azuretools.vscode-docker).

​​​	您可以按照使用 Docker 教程构建项目、生成 Docker 映像，并通过 Microsoft Docker 扩展将其推送到公共或专用容器注册表。

## [Create and config a Kubernetes cluster 创建和配置 Kubernetes 集群]({{< ref "/Azure/Kubernetes#_create-and-config-a-kubernetes-cluster" >}})
...
## [Deploy the application to Azure Kubernetes Service 将应用程序部署到 Azure Kubernetes 服务]({{< ref "/Azure/Kubernetes#_deploy-the-application-to-azure-kubernetes-service" >}})
...
### [Checking on your deployment 检查您的部署]({{< ref "/Azure/Kubernetes#_checking-on-your-deployment" >}})
...
## [Next steps 后续步骤]({{< ref "/Azure/Kubernetes#_next-steps" >}})
