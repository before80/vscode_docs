...
​​​	此视频解释了 VS Code 如何与 C# Dev Kit 扩展一起提供高效且强大的 C# 开发环境。
...
​​​	了解如何安装 Visual Studio Code 和 C# Dev Kit，并创建您的第一个 C# 项目。
...
​​​	此视频向您展示如何使用 C# Dev Kit 中的解决方案资源管理器导航 C# 项目。
...
​​​	此视频向您展示如何在 VS Code 中编写 C# 代码，并发现您可以在其中使用的很酷的生产力工具！
...
​​​	此视频演示如何使用 C# Dev Kits 调试工具调试 C# 应用程序。
...
​​​	此视频介绍了如何为 VS Code 中更好的 C# 体验做出贡献。
