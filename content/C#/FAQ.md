...
## [General 常规]({{< ref "/C#/FAQ#_general" >}})

### [What is C# Dev Kit? 什么是 C# Dev Kit？]({{< ref "/C#/FAQ#_what-is-c-dev-kit" >}})
...
### [What extensions are included in C# Dev Kit? C# Dev Kit 中包含哪些扩展？]({{< ref "/C#/FAQ#_what-extensions-are-included-in-c-dev-kit" >}})
...
### [Who can use C# Dev Kit? 谁可以使用 C# Dev Kit？]({{< ref "/C#/FAQ#_who-can-use-c-dev-kit" >}})
...
### [Where do I submit feedback and suggestions? 我可以在哪里提交反馈和建议？]({{< ref "/C#/FAQ#_where-do-i-submit-feedback-and-suggestions" >}})
...
### [Is C# Dev Kit open source? Why not? C# Dev Kit 是开源的吗？为什么不是？]({{< ref "/C#/FAQ#_is-c-dev-kit-open-source-why-not" >}})
...
### [How can I contribute? 我可以如何做出贡献？]({{< ref "/C#/FAQ#_how-can-i-contribute" >}})
...
## [.NET SDK]({{< ref "/C#/FAQ#_net-sdk" >}})

### [Install script timed out 安装脚本超时]({{< ref "/C#/FAQ#_install-script-timed-out" >}})
...
[Learn more about configuring VS Code settings]({{< ref "/GetStarted/Settings" >}}) and see below for an example of a custom timeout in a `settings.json` file. In this example, the custom timeout value is 180 seconds, or 3 minutes:
...
### [Error acquiring .NET 7 获取 .NET 7 时出错]({{< ref "/C#/FAQ#_error-acquiring-net-7" >}})
...
### [How do I manually install .NET? 如何手动安装 .NET？]({{< ref "/C#/FAQ#_how-do-i-manually-install-net" >}})
...
### [The extension thinks I am offline with error response of 400 or 407, and I have a proxy 扩展认为我处于脱机状态，错误响应为 400 或 407，并且我有一个代理]({{< ref "/C#/FAQ#_the-extension-thinks-i-am-offline-with-error-response-of-400-or-407-and-i-have-a-proxy" >}})
...
## [Project System 项目系统]({{< ref "/C#/FAQ#_project-system" >}})

### [The Solution Explorer reports that my project is not supported in C# Dev Kit 解决方案资源管理器报告我的项目在 C# Dev Kit 中不受支持]({{< ref "/C#/FAQ#_the-solution-explorer-reports-that-my-project-is-not-supported-in-c-dev-kit" >}})
...
### [I clicked on the "Create .NET Project" button and nothing happened 我单击了“创建 .NET 项目”按钮，但没有任何反应]({{< ref "/C#/FAQ#_i-clicked-on-the-create-net-project-button-and-nothing-happened" >}})
...
### [The Project System reports that it ran into a problem 项目系统报告遇到问题]({{< ref "/C#/FAQ#_the-project-system-reports-that-it-ran-into-a-problem" >}})
...
### [When I open my solution, I get the notification "Failed to restore solution" 当我打开解决方案时，我收到通知“未能还原解决方案”]({{< ref "/C#/FAQ#_when-i-open-my-solution-i-get-the-notification-failed-to-restore-solution" >}})
...
### [The Solution Explorer displays "A compatible .NET SDK was not found" 解决方案资源管理器显示“未找到兼容的 .NET SDK”]({{< ref "/C#/FAQ#_the-solution-explorer-displays-a-compatible-net-sdk-was-not-found" >}})
...
## [Test Explorer 测试资源管理器]({{< ref "/C#/FAQ#_test-explorer" >}})

### [Why don't my tests appear in the Test Explorer panel? 为什么我的测试未显示在测试资源管理器面板中？]({{< ref "/C#/FAQ#_why-dont-my-tests-appear-in-the-test-explorer-panel" >}})
...
### [My tests appear in the Test Explorer panel, but I cannot debug them 我的测试出现在测试资源管理器面板中，但我无法调试它们]({{< ref "/C#/FAQ#_my-tests-appear-in-the-test-explorer-panel-but-i-cannot-debug-them" >}})
...
### [I just added new tests to my test project, and they are not appearing in the Test Explorer panel? 我刚刚向测试项目添加了新测试，但它们未出现在测试资源管理器面板中？]({{< ref "/C#/FAQ#_i-just-added-new-tests-to-my-test-project-and-they-are-not-appearing-in-the-test-explorer-panel" >}})
...
## [Debugger 调试器]({{< ref "/C#/FAQ#_debugger" >}})

### [When I F5, nothing happens 按 F5 时，没有任何反应]({{< ref "/C#/FAQ#_when-i-f5-nothing-happens" >}})
...
### [When I F5, it asks me to "Select a Debugger". How do I know which one to pick? 按 F5 时，系统提示我“选择调试器”。我如何知道选择哪一个？]({{< ref "/C#/FAQ#_when-i-f5-it-asks-me-to-select-a-debugger-how-do-i-know-which-one-to-pick" >}})
...
### [Why is debugging not working? 为什么调试不起作用？]({{< ref "/C#/FAQ#_why-is-debugging-not-working" >}})
...
### [While debugging, my breakpoints aren't binding 调试时，我的断点未绑定]({{< ref "/C#/FAQ#_while-debugging-my-breakpoints-arent-binding" >}})
...
## [C# Editor C# 编辑器]({{< ref "/C#/FAQ#_c-editor" >}})

### [How do I get IntelliSense to work correctly? 如何让 IntelliSense 正确工作？]({{< ref "/C#/FAQ#_how-do-i-get-intellisense-to-work-correctly" >}})
...
### [C# extension fails to launch the server C# 扩展程序无法启动服务器]({{< ref "/C#/FAQ#_c-extension-fails-to-launch-the-server" >}})
...
### [I have too many diagnostics or I don't have enough diagnostics 我有太多诊断或我没有足够的诊断]({{< ref "/C#/FAQ#_i-have-too-many-diagnostics-or-i-dont-have-enough-diagnostics" >}})
...
If you're not seeing enough diagnostics or none at all, it's possible that your project isn't fully loaded. To check if this is the case, refer to the section [How do I get IntelliSense to work correctly?]({{< ref "/C#/FAQ#_how-do-i-get-intellisense-to-work-correctly" >}}) It provides instructions on how to verify if your project is fully loaded.

​​​	如果您没有看到足够的诊断或根本没有看到诊断，则可能是您的项目未完全加载。若要检查是否如此，请参阅“如何让 IntelliSense 正常工作？”一节。它提供了有关如何验证您的项目是否已完全加载的说明。

## [Razor Editor Razor 编辑器]({{< ref "/C#/FAQ#_razor-editor" >}})

### [Most or all Blazor components show up with warnings 大多数或所有 Blazor 组件都显示警告]({{< ref "/C#/FAQ#_most-or-all-blazor-components-show-up-with-warnings" >}})
...
### [Target framework errors are mentioned in Razor files 目标框架错误在 Razor 文件中提及]({{< ref "/C#/FAQ#_target-framework-errors-are-mentioned-in-razor-files" >}})
...
## [IntelliCode]({{< ref "/C#/FAQ#_intellicode" >}})

### [I am not getting whole line completions 我没有获得整行补全]({{< ref "/C#/FAQ#_i-am-not-getting-whole-line-completions" >}})

Whole line completions are disabled when the [GitHub Copilot](https://marketplace.visualstudio.com/items?itemName=GitHub.copilot) extension is enabled to allow you to take advantage of the more advanced [AI completion]({{< ref "/UserGuide/GitHubCopilot" >}}) capabilities. You can verify that Copilot is enabled by checking if the Copilot logo is present in the lower right corner of VS Code.

​​​	在启用 GitHub Copilot 扩展时，整行补全功能被禁用，以便您可以利用更高级的 AI 补全功能。您可以通过检查 VS Code 右下角是否存在 Copilot 徽标来验证是否启用了 Copilot。

## [Hot Reload 热重载]({{< ref "/C#/FAQ#_hot-reload" >}})

### [Hot Reload icon not appearing after I started debugging 开始调试后热重载图标未出现]({{< ref "/C#/FAQ#_hot-reload-icon-not-appearing-after-i-started-debugging" >}})

The debugger only starts a Hot Reload session if the option for Hot Reload is enabled in the C# Dev Kit [debugger settings]({{< ref "/C#/RunandDebug#_user-settings" >}}). If the option is enabled, it is expected that the Hot Reload icon appears in the status bar while debugging:
...
You can either click on the Hot Reload icon or can see diagnostic information by opening the **C# Hot Reload** Output window. If you don't see either of those, the project may not be supported by C# Dev Kit extension, see [Hot Reload supported projects]({{< ref "/C#/RunandDebug#_supported-projects-and-scenarios" >}}).

​​​	您可以单击热重载图标，也可以通过打开 C# 热重载输出窗口来查看诊断信息。如果您看不到这些内容，则该项目可能不受 C# Dev Kit 扩展支持，请参阅热重载支持的项目。

### [What types of edits are supported with Hot Reload? 热重载支持哪些类型的编辑？]({{< ref "/C#/FAQ#_what-types-of-edits-are-supported-with-hot-reload" >}})
